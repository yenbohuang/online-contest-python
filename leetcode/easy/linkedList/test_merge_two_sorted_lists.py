        ...
        if l1 is None or l2 is None:
            ...
            while current2 is not None:
                ...
                if answer.val > current2.val:
                    ...
                    while answerCurrent2.next is not None:
...
class TestSolution(unittest.TestCase):
    ...
    def test_case_1(self):
        ...
        self.assertEqual(str(self.solution.mergeTwoLists(
            list1, list2)), "1->2->3->8->11->15")
    ...
    def test_case_2(self):
        ...
        self.assertEqual(
            str(self.solution.mergeTwoLists(list1, list2)), "0->3->3")
